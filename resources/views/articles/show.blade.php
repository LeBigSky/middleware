            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <section class="max-w-4xl p-6 mx-auto ">
                        <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">article n°: {{ $article->id }}</h2>
                            ...
                            <h2 class="mt-2 text-2xl font-semibold text-gray-800 dark:text-white md:mt-0 md:text-3xl">{{ $article->titre }}</h2>
                        
                            <p class="mt-2 text-gray-600 dark:text-gray-200">{{ $article->texte }}</p>
                        
                            <div class="flex justify-end mt-4">
                                <a href="#" class="text-xl font-medium text-blue-600 dark:text-blue-300" tabindex="0" role="link">{{ $article->id }}</a>
                            </div>
                        </div>
